...
def main(assembly_files, num_cycles):
    ...
    for assembly_file in assembly_files:
        ...
        # Creates ref file
        if num_cycles == -1:
            cmd = "java -jar venus-cs61c-su19.jar " + assembly_file + " -it -t -tf trace_format -ti -ts -ur > " + ref_output + " 2> " + error_file_name
        else:
            cmd = "java -jar venus-cs61c-su19.jar " + assembly_file + " -it -t -tf trace_format -ti -ts -ur -tn " + str(num_cycles + 1) + " > " + ref_output + " 2> " + error_file_name
        ...
        # Creates hex file
        os.system("java -jar venus-cs61c-su19.jar -d " + assembly_file + " > " + hex_file)
